...
The Color layer is the base layer. The color layer has four channels: R,G,B and A
The R,G and B channels encode the color of the pixels as Red, Green and Blue
The A codes the transparency of the pixel and is called the Alpha channel. When A=0, the pixel is transparent. When A=1 the pixel is opaque.
